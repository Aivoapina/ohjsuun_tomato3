...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myQFrame_t, stringdata) + ofs \
...
void myQFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (myQFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myQFrame::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject myQFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_myQFrame.data,
      qt_meta_data_myQFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myQFrame.stringdata))
