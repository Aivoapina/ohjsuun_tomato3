...
QT_MOC_LITERAL(5, 42, 5)
    ...
    "Map\0indexChanged\0\0liikuJohonkin\0"
    "direction\0index"
};
...
void Map::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->liikuJohonkin((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (Map::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Map::indexChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Map::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_Map.data,
